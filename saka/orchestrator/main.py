...
from saka.shared.models import ConsolidatedDataInput, AthenaSentimentOutput, SentinelRiskOutput
...
async def trigger_decision_cycle(request: CycleTriggerRequest):
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            responses = await asyncio.gather(athena_task, sentinel_task)

            # Validação e parsing das respostas
            athena_response, sentinel_response = responses
